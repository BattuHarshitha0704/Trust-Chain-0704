      ...
      <div className="container mx-auto max-w-4xl z-10 animate-fade-in">
        <div className="flex justify-center mb-8">
          <div className="relative">
            ...
            <div className="relative bg-safespeak-dark p-4 rounded-full">
              <Shield className="h-16 w-16 text-safespeak-blue" />
            </div>
          </div>
        </div>
        
        <h1 className="text-4xl md:text-6xl font-bold mb-6">
          Secure, Anonymous <span className="text-safespeak-blue">Crime Reporting</span>
        </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
          {features.map((feature, index) => (
            <div key={index} className="glass-card p-6 rounded-xl">
              <div className="bg-safespeak-blue/10 p-3 rounded-lg w-fit mb-4">
                <feature.icon className="h-6 w-6 text-safespeak-blue" />
              </div>
