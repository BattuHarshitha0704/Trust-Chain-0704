...
const mockFeedback: Feedback[] = [
  {
    ...
    type: 'investigation',
    description: 'The investigator was very thorough and professional in handling my case. They kept me updated throughout the process.',
    date: '2025-04-07',
    status: 'unread'
  },
  {
    id: 'FB-23456',
    reportId: 'RPT-E5F6G7H8',
    type: 'resolution',
    description: 'My case was resolved quickly, but I feel like more could have been done to recover my stolen items.',
    date: '2025-04-06',
    status: 'read'
  },
  {
    id: 'FB-34567',
    reportId: 'RPT-I9J0K1L2',
    type: 'admin',
    description: 'The admin who handled my case was rude and dismissive of my concerns.',
    date: '2025-04-05',
    status: 'flagged'
  },
  {
    ...
    reportId: null,
    type: 'other',
    description: 'The app interface is a bit confusing to navigate. It would be helpful to have better instructions.',
    date: '2025-04-04',
    status: 'read'
  },
  {
    id: 'FB-56789',
    reportId: 'RPT-M3N4O5P6',
    type: 'investigation',
    description: 'I appreciate how seriously my case was taken. The investigation was handled professionally.',
    date: '2025-04-03',
    status: 'resolved'
  }
];
